...
function SinglePriority({singlePriority, index}: {singlePriority: Priority, index: number}) {
    ...
    return <div onClick={() => updateThePriority(index)} className={`${singlePriority.isSelected && "bg-royal-blue-50 border border-royal-blue-200"} flex items-center gap-2 p-[7px] rounded-md cursor-pointer`}>
